...
Invite a friend during our launch boost: both earn 2000 points.`,
    tips: [
...
Sorting proof is what makes you a builder in Kenya's founding season. Stack quiz points with approved sorts to climb the weekly leaderboard and your lifetime Eco Guardian path.`,
  ...
  },
  {
    ...
    description:
      'Launch boost: 2000 + 2000 points when a friend joins with your link. Help us grow the weekly board for everyone.',
    icon: 'public',
    status: 'ACTIVE',
    missionWeek: 1,
    missionDay: 6,
    content: `Growth rewards everyone. During our launch boost, you and your friend each earn 2000 points when they join with your referral link.
